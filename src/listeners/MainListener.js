...
module.exports = class MainListener extends EventListener {
  ...
  onReady () {
    ...
    // Lavalink connection
    if (`[{"host": "127.0.0.1", "port": 1337, "password": "passwordlavalink", "region": "asia|eu|us|sam"}]`) {
      try {
        let nodes = JSON.parse(`[{"host": "127.0.0.1", "port": 1337, "password": "passwordlavalink", "region": "asia|eu|us|sam"}]`)
